...
func validate_keybinding_config():
	...
	if typeof(Config.get_value("keybinding", "throttle")) != TYPE_STRING:
		...
		state = false
	if typeof(Config.get_value("keybinding", "reverse")) != TYPE_STRING:
		print('Found invalid config! "[keybinding] reverse != TYPE_STRING"')
		state = false
	if typeof(Config.get_value("keybinding", "steer_left")) != TYPE_STRING:
		print('Found invalid config! "[keybinding] steer_left != TYPE_STRING"')
		state = false
	if typeof(Config.get_value("keybinding", "steer_right")) != TYPE_STRING:
		print('Found invalid config! "[keybinding] steer_right != TYPE_STRING"')
		state = false
	if typeof(Config.get_value("keybinding", "tilt_up")) != TYPE_STRING:
		print('Found invalid config! "[keybinding] tilt_up != TYPE_STRING"')
		state = false
	if typeof(Config.get_value("keybinding", "tilt_down")) != TYPE_STRING:
		print('Found invalid config! "[keybinding] tilt_down != TYPE_STRING"')
		state = false
	if typeof(Config.get_value("keybinding", "tilt_left")) != TYPE_STRING:
		print('Found invalid config! "[keybinding] tilt_left != TYPE_STRING"')
		state = false
	if typeof(Config.get_value("keybinding", "tilt_right")) != TYPE_STRING:
		print('Found invalid config! "[keybinding] tilt_right != TYPE_STRING"')
		state = false
	if typeof(Config.get_value("keybinding", "jump")) != TYPE_STRING:
		print('Found invalid config! "[keybinding] jump != TYPE_STRING"')
		state = false
	if typeof(Config.get_value("keybinding", "slide")) != TYPE_STRING:
		print('Found invalid config! "[keybinding] slide != TYPE_STRING"')
		state = false
	if typeof(Config.get_value("keybinding", "boost")) != TYPE_STRING:
		print('Found invalid config! "[keybinding] boost != TYPE_STRING"')
		state = false
	if typeof(Config.get_value("keybinding", "ball_cam")) != TYPE_STRING:
