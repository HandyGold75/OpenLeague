...
@onready var throttle_button = $MarginContainer/VBoxContainer/HBoxContainer/VBoxContainer/HBoxContainer/Throttle
@onready var reverse_button = $MarginContainer/VBoxContainer/HBoxContainer/VBoxContainer/HBoxContainer2/Reverse
@onready var steer_left_button = $"MarginContainer/VBoxContainer/HBoxContainer/VBoxContainer/HBoxContainer3/Steer Left"
@onready var steer_right_button = $"MarginContainer/VBoxContainer/HBoxContainer/VBoxContainer/HBoxContainer4/Steer Right"
@onready var tilt_up_button = $"MarginContainer/VBoxContainer/HBoxContainer/VBoxContainer2/HBoxContainer/Tilt Up"
@onready var tilt_down_button = $"MarginContainer/VBoxContainer/HBoxContainer/VBoxContainer2/HBoxContainer2/Tilt Down"
@onready var tilt_left_button = $"MarginContainer/VBoxContainer/HBoxContainer/VBoxContainer2/HBoxContainer3/Tilt Left"
@onready var tilt_right_button = $"MarginContainer/VBoxContainer/HBoxContainer/VBoxContainer2/HBoxContainer4/Tilt Right"
@onready var jump_button = $MarginContainer/VBoxContainer/HBoxContainer/VBoxContainer/HBoxContainer5/Jump
@onready var slide_button = $MarginContainer/VBoxContainer/HBoxContainer/VBoxContainer/HBoxContainer6/Boost
@onready var boost_button = $MarginContainer/VBoxContainer/HBoxContainer/VBoxContainer2/HBoxContainer5/Slide
@onready var ball_cam_button = $"MarginContainer/VBoxContainer/HBoxContainer/VBoxContainer2/HBoxContainer6/Ball Cam"
...
func _input(event: InputEvent):
	if !is_remapping || !(event is InputEventKey || event is InputEventMouseButton || event is InputEventJoypadButton):
		return
